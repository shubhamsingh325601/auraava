...
export default function NewFounderStoryPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                alert('Failed to create founder story')
            }
        } catch (error) {
            console.error('Failed to create founder story:', error)
            alert('Failed to create founder story')
        } finally {
            setLoading(false)
        }
    ...
    return (
        <div className="min-h-screen bg-ivory">
            <AdminPageHeader icon={Users} eyebrow="Our Story" title="Add Founder Story" backHref="/admin/founder-stories" />
                ...
                <form onSubmit={handleSubmit} className="bg-cream rounded-2xl shadow-card p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={2}
                            className="w-full px-4 py-3 bg-white border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all"
                            placeholder="A short, memorable line from the founder..."
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={6}
                            className="w-full px-4 py-3 bg-white border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all"
                            placeholder="The full founder story..."
                        />
                    ...
                    <div className="flex gap-4 pt-4">
                        ...
                        >
                            {loading ? 'Creating...' : 'Create Founder Story'}
                        </Button>
