...
export default function NewHairCarePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                alert('Failed to create hair care tip')
            }
        } catch (error) {
            console.error('Failed to create hair care tip:', error)
            alert('Failed to create hair care tip')
        } finally {
            setLoading(false)
        }
    ...
    return (
        <div className="min-h-screen bg-ivory">
            <AdminPageHeader icon={Sparkles} eyebrow="Hair Care" title="Add New Hair Care Tip" backHref="/admin/hair-care" />
                ...
                <form onSubmit={handleSubmit} className="bg-cream rounded-2xl shadow-card p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={4}
                            className="w-full px-4 py-3 bg-white border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all"
                            placeholder="Describe the hair care tip..."
                        />
                    </div>
                    ...
                    <div className="flex gap-4 pt-6 border-t border-border">
                        ...
                        >
                            {loading ? 'Creating...' : 'Create Hair Care Tip'}
                        </Button>
