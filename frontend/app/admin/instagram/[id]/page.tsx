...
export default function EditInstagramPage({ params }: { params: { id: string } }) {
    ...
    return (
        <div className="min-h-screen bg-ivory">
            <AdminPageHeader icon={Instagram} eyebrow="Instagram" title="Edit Instagram Post" backHref="/admin/instagram" />
