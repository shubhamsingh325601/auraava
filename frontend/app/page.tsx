...
export const metadata: Metadata = {
    title: "Auraava - Rooted in Rituals | Natural Hair Care Products",
    description: "Rooted in rituals. Natural hair care products with pure ingredients. Organic, cruelty-free shampoos, oils, serums, and sprays for radiant hair.",
    alternates: {
        canonical: '/',
    },
}
    ...
    return (
        <div className="min-h-screen bg-background overflow-x-hidden w-full">
            ...
            <main className="overflow-x-hidden w-full">
                <h1 className="sr-only">Auraava — Rooted in Rituals. Natural Hair Care Products.</h1>
                <HeroCarousel />
                <TrustBar />
                <Categories />
                <SpecialOffer />
